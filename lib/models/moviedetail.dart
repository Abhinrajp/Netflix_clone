...
class Getmoviedetailmodel {
  ...
  factory Getmoviedetailmodel.fromRawJson(String str) =>
      Getmoviedetailmodel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory Getmoviedetailmodel.fromJson(Map<String, dynamic> json) =>
      Getmoviedetailmodel(
        adult: json["adult"],
